...
export default async function handler(req, res) {
    ...
    const { action, guideData, accessToken } = req.body;
    if (!action || !guideData || !accessToken) {
    ...
    try {
        ...
        switch (action) {
            ...
            case 'update':
                ...
                break;
            case 'delete':
                guides.guides = guides.guides.filter(g => g.id !== guideData.id);
                break;
            default:
        ...
        guides.meta.updatedBy = guideData.author || 'Unknown';
        ...
        await octokit.repos.createOrUpdateFileContents({
            ...
            repo: process.env.GITHUB_REPO,
            path: 'guides/guides.json',
            message: `${action} guide: ${guideData.title}`,
